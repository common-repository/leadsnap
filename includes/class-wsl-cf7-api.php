...
class Wncrm_Cf7_Api extends Wncrm_Base{
    ...
    public function is_already_called(){
        $is_called = get_transient( 'wncrm_is_already_called' );
        if($is_called){
            ...
            set_transient( 'wncrm_is_already_called', $data , 10 );
            return false;
        }
    }
    ...
    public function get_source_data(){
        ...
        $company_id = wncrm_get_cf7_post_setting('send_to_company', $this->cf7->id());
        if(!$company_id){
