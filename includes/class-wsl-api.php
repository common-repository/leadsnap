...
class Wncrm_Api{
    ...
    public $api_url = 'https://app.leadsnap.com/public/api/';
    ...
    public function get_companies(){
        ...
        //$prev_setting = wncrm_get_settings();
        ...
        if($response->type == 'error'){
            ...
            wncrm_update_setting("send_to_company",$response->data->id);
        }
        return $response;
    }
