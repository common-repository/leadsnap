...
$meta = wncrm_get_cf7_post_settings($post->id);
$api_obj = new Wncrm_Api();
$companies = $api_obj->get_companies();

wp_nonce_field( 'wncrm_cf7_editor_panel', 'wncrm_cf7_editor_panel_nonce' );
?>
...
<table class="form-table">
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?php include_once WNCRM_ADMIN_DIR.'/partials/send_to_company_field.php'; ?>
            </td>
        </tr>
    </tbody>
</table>