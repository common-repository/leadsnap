...
class Wncrm_Admin{
    ...
    private $page_title = 'LeadSnap Settings';
    ...
    public function create_admin_page()
    {
        ...
        <div class="wrap">
            ...
            <?php
                ...
                settings_fields( 'wncrm_options_group' );
    ...
    {        
        register_setting(
            'wncrm_options_group', // Option group
    ...
    public function sent_to_crm_callback(){
        echo '<label>';
        echo '<input '. checked(wncrm_get_setting('send_to_crm'), 1, false).' type="checkbox" id="send_to_crm" name="wsl_settings[send_to_crm]" class="regular-text" value="1" />';
    ...
    public function sent_to_company_callback(){
        ...
        $meta = wncrm_get_settings();
        include_once WNCRM_ADMIN_DIR.'/partials/send_to_company_field.php';
    }
